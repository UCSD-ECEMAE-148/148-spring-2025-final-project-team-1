...
class ThreePointTurn(Node):
    def __init__(self):
        ...
        self.turn_speed = -0.5      # rad/s (negative for right turn)
        
        # Timing parameters
        self.reverse_duration_1 = 2.4    # Duration for first reverse+turn
        self.forward_duration = 2.95      # Duration for straight forward
        self.reverse_duration_2 = 2.4    # Duration for second reverse+turn
